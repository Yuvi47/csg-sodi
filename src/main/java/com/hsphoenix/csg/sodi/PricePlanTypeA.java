...
/**
 * <p>Java class for pricePlanTypeA complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="pricePlanTypeA">
 *   &lt;complexContent>
...
@XmlType(name = "pricePlanTypeA", propOrder = {
    "identifier",
    "beginDate",
    "originalIdentifier",
    "originalBeginDate"
})
public class PricePlanTypeA {
    ...
    @XmlElement(name = "OriginalBeginDate", required = true)
    @XmlSchemaType(name = "date")
